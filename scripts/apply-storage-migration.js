...
async function applyMigration() {
  try {
    ...
    const migrationPath = path.join(
      ...
      'supabase',
      'migrations',
      '20250601_create_profile_storage.sql'
    );
    ...
    if (error) {
      ...
      console.log(
        '3. Allow authenticated users to upload their own avatars to user_avatars bucket'
      );
      console.log(
        '4. Allow authenticated users to update their own avatars in user_avatars bucket'
      );
      console.log(
        '5. Allow authenticated users to delete their own avatars in user_avatars bucket'
      );
    } else {
