  ...
  return (
    ...
    >
      <Link href={`/services/${service.slug}`}>
        <div 
          className={`relative h-full backdrop-blur-lg rounded-2xl p-6 border shadow-lg overflow-hidden transition-all duration-300 ${
            isHovered 
              ? 'bg-gradient-to-br from-pink-50/90 to-pink-100/90 dark:from-pink-900/30 dark:to-pink-800/30 border-pink-200/50 dark:border-pink-900/50' 
              : 'bg-white/80 dark:bg-gray-800/80 border-white/30 dark:border-gray-700/50'
          }`}
        >
