  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-blue-50 via-purple-50 to-indigo-50 py-12">
          <div className="container mx-auto px-6 text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              About <span className="text-pink-700">bright</span> <span className="text-orange-500">lambs</span>
            </h1>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 font-baloo2">
                Why we started <span className="text-pink-700">Bright</span>{' '}
                <span className="text-orange-500">Lambs</span>
              </h2>
              <div className="text-lg text-gray-700 mb-8 text-left space-y-4">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto font-[var(--font-nunito)]">
