      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#services" className="text-gray-400 hover:text-white transition-colors">Business Analysis</Link></li>
              <li><Link href="#services" className="text-gray-400 hover:text-white transition-colors">Data Analytics</Link></li>
              <li><Link href="#services" className="text-gray-400 hover:text-white transition-colors">Process Improvement</Link></li>
              <li><Link href="#services" className="text-gray-400 hover:text-white transition-colors">Stakeholder Management</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-gray-700 dark:border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p className="font-baloo2">
            &copy; {new Date().getFullYear()} <span className="text-pink-700 dark:text-pink-400">Bright</span>{' '}
            <span className="text-orange-500 dark:text-orange-400">Lambs</span>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
