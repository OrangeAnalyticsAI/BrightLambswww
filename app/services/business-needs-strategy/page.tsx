...
export default function BusinessNeedsStrategy() {
  ...
  const content = [
    <div key="section1">
      <h2 className="mb-3 text-2xl font-semibold">1. Framing Strategy & Business Needs</h2>
      <p className="mb-4">
    ...
    <div key="section2">
      <h2 className="mb-3 text-2xl font-semibold">2. Environmental & Competitive Research</h2>
      <p className="mb-4">Key to this work is analysing both internal and external forces:</p>
    ...
    <div key="section3">
      <h2 className="mb-3 text-2xl font-semibold">3. SWOT & Gap Analysis</h2>
