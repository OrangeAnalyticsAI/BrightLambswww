...
export default function RequirementsElicitation() {
  ...
  const content = [
    <div key="section1">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">1. Preparation & Context Setting</h2>
    ...
    <div key="section2">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">2. Stakeholder Engagement</h2>
      <p className="text-gray-700 mb-4">
        Analysts engage stakeholders through a tailored mix of techniques:
      </p>
      <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
        <li><span className="font-medium">Structured Interviews</span> allow deep insights from individuals or small groups, guided by prepared questions and prompts.</li>
        <li><span className="font-medium">Workshops or Focus Groups</span> such as JAD (Joint Application Design) enable collective exploration, debate, and consensus gathering in facilitated sessions.</li>
        <li><span className="font-medium">Observation or Shadowing</span> involves watching users as they perform real tasks to uncover tacit knowledge not expressed explicitly.</li>
        <li><span className="font-medium">Surveys or Questionnaires</span> can capture broad feedback from many users, useful for early-stage requirement discovery.</li>
        <li><span className="font-medium">Prototyping & Walkthroughs</span>, including wireframes or use-case diagrams, help stakeholders visualise potential solutions and trigger valuable responses.</li>
      </ul>
    </div>,
    
    <div key="section3">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">3. Documenting & Modelling Requirements</h2>
      <p className="text-gray-700 mb-4">
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
        ...
        <li>Non-Functional Requirements specifying performance, security, usability, and compliance needs.</li>
      </ul>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section4">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">4. Validation & Confirmation</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section5">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">5. Prioritisation & Trade-offs</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section6">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">6. Integration & Traceability</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section7">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">7. Ongoing Requirements Management</h2>
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700">
        <li><span className="font-medium">Ensures solution design genuinely addresses core business needs</span> while reducing risk of rework or wasted investment.</li>
        <li><span className="font-medium">Promotes stakeholder alignment, mutual understanding, and trust</span> through active engagement.</li>
        <li><span className="font-medium">Enables disciplined documentation and traceability</span>, essential for complex, regulated, or multi-vendor projects.</li>
        <li><span className="font-medium">Supports agile delivery</span> by translating business needs into test-driven artefacts, ensuring each increment delivers real value.</li>
      </ul>
