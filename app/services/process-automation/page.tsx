...
export default function ProcessAutomation() {
  ...
  const content = [
    <div key="section1">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">1. Identifying and Prioritising Automation Opportunities</h2>
    ...
    <div key="section2">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">2. Documenting As‑Is and To‑Be Workflows</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section3">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">3. Tool Evaluation & Selection</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section4">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">4. Integration Design & Architecture</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section5">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">5. Development Oversight & Quality Assurance</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section6">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">6. Change Management & Training</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section7">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">7. Deployment & Monitoring</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section8">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">8. Benefits Realisation & Continuous Improvement</h2>
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700">
        <li><span className="font-medium">Efficiency and accuracy:</span> frees skilled staff from mundane tasks, allowing focus on higher-value work</li>
        <li><span className="font-medium">Consistency and reliability:</span> automation enforces standards and reduces human error</li>
        <li><span className="font-medium">Scalability:</span> repeatable automated workflows scale without proportional increase in cost</li>
        <li><span className="font-medium">Insights for evolution:</span> data from automation reveals new improvement opportunities</li>
      </ul>
