...
export default function StrategicEnterpriseAnalysis() {
  ...
  const content = [
    <div key="section1">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">1. Framing Strategy & Business Needs</h2>
    ...
    <div key="section2">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">2. Environmental & Competitive Research</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section3">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">3. SWOT & Gap Analysis</h2>
      <p className="text-gray-700 mb-4">
