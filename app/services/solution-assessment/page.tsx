...
export default function SolutionAssessment() {
  ...
  const content = [
    <div key="section1">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">1. Defining Evaluation Criteria</h2>
    ...
    <div key="section2">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">2. Market and Vendor Research</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section3">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">3. Facilitating Evaluation Processes</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section4">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">4. Analysing Findings & Comparing Options</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section5">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">5. Recommending & Securing Approval</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section6">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">6. Transition Design & Readiness Planning</h2>
      <p className="text-gray-700 mb-4">
    ...
    <div key="section7">
      <h2 className="text-2xl font-semibold text-gray-900 mb-3">7. Post-Selection Evaluation</h2>
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700">
        <li><span className="font-medium">Brings a structured, data-driven approach</span> to complex decisions</li>
        <li><span className="font-medium">Reduces risk</span> through objective comparison and transparent scoring</li>
        <li><span className="font-medium">Ensures chosen solutions genuinely meet stakeholder needs</span> and context</li>
        <li><span className="font-medium">Facilitates smoother adoption</span> with readiness and user-centred transition planning</li>
      </ul>
